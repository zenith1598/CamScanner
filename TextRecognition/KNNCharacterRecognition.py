...
###################################################################################################
from TextRecognition.ContourWithData import ContourWithData

allContoursWithData = []  # declare empty lists,
validContoursWithData = []  # we will fill these shortly

npaClassifications = np.loadtxt(r"classifications.txt",
...
npaFlattenedImages = np.loadtxt(r"flattened_images.txt", np.float32)  # read in training images
...
imgTestingNumbers = cv2.imread(r'C:\opencvpictures\Template.jpg')  # read in testing numbers image
