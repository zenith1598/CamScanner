...
def main():
    imgTrainingNumbers = cv2.imread(r'C:\opencvpictures\training_chars.png')  # read in training numbers image
    ...
    np.savetxt("C:\opencvpictures\classifications.txt", npaClassifications)  # write flattened images to file

    np.savetxt("\C:\opencvpictures\flattened_images.txt", npaFlattenedImages)  #
